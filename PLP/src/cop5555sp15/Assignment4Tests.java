...
public class Assignment4Tests {
	...
	/**
	 * The next (incomplete) set of tests have typing errors and are expected to
	 * throw a type check error. They should work without extra coding if you
	 * have properly implemented type checking for the features of the previous
	 * cases.
	 */
